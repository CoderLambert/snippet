...
var SnippetsController = exports.SnippetsController = function () {
    var _classDecorators = [(0, common_1.Controller)('snippets')];
    ...
    var SnippetsController = _classThis = /** @class */ (function () {
        function SnippetsController_1(snippetsService) {
            this.snippetsService = (__runInitializers(this, _instanceExtraInitializers), snippetsService);
        }
        SnippetsController_1.prototype.create = function (createSnippetDto) {
            return this.snippetsService.create(createSnippetDto);
        };
        SnippetsController_1.prototype.findAll = function (language, tags) {
            if (language) {
                return this.snippetsService.searchByLanguage(language);
            }
            if (tags) {
                var tagArray = tags.split(',').map(function (tag) { return tag.trim(); });
                return this.snippetsService.searchByTags(tagArray);
            }
            return this.snippetsService.findAll();
        };
        SnippetsController_1.prototype.findOne = function (id) {
            return this.snippetsService.findOne(id);
        };
        SnippetsController_1.prototype.update = function (id, updateSnippetDto) {
            return this.snippetsService.update(id, updateSnippetDto);
        };
        SnippetsController_1.prototype.remove = function (id) {
            return this.snippetsService.remove(id);
        };
        return SnippetsController_1;
    }());
    __setFunctionName(_classThis, "SnippetsController");
    (function () {
        ...
        SnippetsController = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SnippetsController = _classThis;
}();
